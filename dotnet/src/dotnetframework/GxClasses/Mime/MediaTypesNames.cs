...
{
    public static class MediaTypesNames
    {
        ...
        public static string ApplicationXJavascript = "application/x-javascript";

        ///<summary>24bit Linear PCM audio at 8-48kHz, 1-N channels; Defined in RFC 3190</summary>
        public static string AudioL24 = "audio/L24";

        ///<summary>Adobe Flash files for example with the extension .swf</summary>
        public static string ApplicationXShockwaveFlash = "application/x-shockwave-flash";
        ...
        public static string ApplicationAtomXml = "application/atom+xml";
        ...
        public static string TextCmd = "text/cmd";
        ...
        public static string ApplicationXDeb = "application/x-deb";

        ///<summary>Defined in RFC 1847</summary>
        public static string MultipartEncrypted = "multipart/encrypted";

        ///<summary>Defined in RFC 1847</summary>
        public static string MultipartSigned = "multipart/signed";

        ///<summary>Defined in RFC 2616</summary>
        public static string MessageHttp = "message/http";

        ///<summary>Defined in RFC 4735</summary>
        public static string ModelExample = "model/example";
        ...
        public static string ApplicationXmlDtd = "application/xml-dtd";
        ...
        public static string ApplicationEcmascript = "application/ecmascript";

        ///<summary>EDI EDIFACT data; Defined in RFC 1767</summary>
        public static string ApplicationEdifact = "application/EDIFACT";

        ///<summary>EDI X12 data; Defined in RFC 1767</summary>
        public static string ApplicationEdiX12 = "application/EDI-X12";

        ///<summary>Email; Defined in RFC 2045 and RFC 2046</summary>
        public static string MessagePartial = "message/partial";

        ///<summary>Email; EML files, MIME files, MHT files, MHTML files; Defined in RFC 2045 and RFC 2046</summary>
        public static string MessageRfc822 = "message/rfc822";
        ...
        public static string VideoXFlv = "video/x-flv";
        ...
        public static string TextXGwtRpc = "text/x-gwt-rpc";
        ...
        public static string ImageVndMicrosoftIcon = "image/vnd.microsoft.icon";

        ///<summary>IGS files, IGES files; Defined in RFC 2077</summary>
        public static string ModelIges = "model/iges";

        ///<summary>IMDN Instant Message Disposition Notification; Defined in RFC 5438</summary>
        public static string MessageImdnXml = "message/imdn+xml";
        ...
        public static string TextXJqueryTmpl = "text/x-jquery-tmpl";

        ///<summary>KML files (e.g. for Google Earth)</summary>
        public static string ApplicationVndGoogleEarthKmlXml = "application/vnd.google-earth.kml+xml";
        ...
        public static string VideoXMatroska = "video/x-matroska";
        ...
        public static string ApplicationVndMozillaXulXml = "application/vnd.mozilla.xul+xml";
        ...
        public static string AudioMp4 = "audio/mp4";
        ...
        public static string ModelMesh = "model/mesh";
        ...
        ///<summary>OP</summary>
        public static string ApplicationXopXml = "application/xop+xml";

        ///<summary>OpenDocument Graphics; Registered[14]</summary>
        public static string ApplicationVndOasisOpendocumentGraphics = "application/vnd.oasis.opendocument.graphics";
        ...
        public static string ApplicationXPkcs7Mime = "application/x-pkcs7-mime";
        ...
        public static string ApplicationXPkcs7Signature = "application/x-pkcs7-signature";
        ...
        public static string ApplicationXRarCompressed = "application/x-rar-compressed";

        ///<summary>RealAudio; Documented in RealPlayer Customer Support Answer 2559</summary>
        public static string AudioVndRnRealaudio = "audio/vnd.rn-realaudio";

        ///<summary>Resource Description Framework; Defined by RFC 3870</summary>
        public static string ApplicationRdfXml = "application/rdf+xml";
        ...
        public static string AudioWebm = "audio/webm";

        ///<summary>Windows Media Audio Redirector; Documented in Microsoft help page</summary>
        public static string AudioXMsWax = "audio/x-ms-wax";
