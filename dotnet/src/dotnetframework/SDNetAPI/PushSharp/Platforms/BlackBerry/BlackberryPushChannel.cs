...
namespace PushSharp.Blackberry
{
	public class BlackberryPushChannel : Common.PushChannelBase
	{
		...
		public BlackberryPushChannel(BlackberryPushChannelSettings channelSettings, Common.PushServiceSettings serviceSettings) : base(channelSettings, serviceSettings)
		{
