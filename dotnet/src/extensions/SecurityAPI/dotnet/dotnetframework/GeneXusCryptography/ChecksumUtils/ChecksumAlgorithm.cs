...
#pragma warning restore CA1707 // Identifiers should not contain underscores
	...
	public static class ChecksumAlgorithmUtils
	{
		...
		public static string valueOf(ChecksumAlgorithm checksumAlgorithm, Error error)
		{
			...
			switch (checksumAlgorithm)
			{
				case ChecksumAlgorithm.CRC8:
					return "CRC8";
				case ChecksumAlgorithm.CRC8_CDMA2000:
					return "CRC8_CDMA2000";
				case ChecksumAlgorithm.CRC8_DARC:
					return "CRC8_DARC";
				case ChecksumAlgorithm.CRC8_DVB_S2:
					return "CRC8_DVB_S2";
				case ChecksumAlgorithm.CRC8_EBU:
					return "CRC8_EBU";
				case ChecksumAlgorithm.CRC8_I_CODE:
					return "CRC8_I_CODE";
				case ChecksumAlgorithm.CRC8_ITU:
					return "CRC8_ITU";
				case ChecksumAlgorithm.CRC8_MAXIM:
					return "CRC8_MAXIM";
				case ChecksumAlgorithm.CRC8_ROHC:
					return "CRC8_ROHC";
				case ChecksumAlgorithm.CRC8_WCDMA:
					return "CRC8_WCDMA";
				case ChecksumAlgorithm.CRC16_AUG_CCITT:
					return "CRC16_AUG_CCITT";
				case ChecksumAlgorithm.CRC16_CCITT_FALSE:
					return "CRC16_CCITT_FALSE";
				case ChecksumAlgorithm.CRC16_ARC:
					return "CRC16_ARC";
				case ChecksumAlgorithm.CRC16_BUYPASS:
					return "CRC16_BUYPASS";
				case ChecksumAlgorithm.CRC16_CDMA2000:
					return "CRC16_CDMA2000";
				case ChecksumAlgorithm.CRC16_DDS_110:
					return "CRC16_DDS_110";
				case ChecksumAlgorithm.CRC16_DECT_R:
					return "CRC16_DECT_R";
				case ChecksumAlgorithm.CRC16_DECT_X:
					return "CRC16_DECT_X";
				case ChecksumAlgorithm.CRC16_DNP:
					return "CRC16_DNP";
				case ChecksumAlgorithm.CRC16_EN_13757:
					return "CRC16_EN_13757";
				case ChecksumAlgorithm.CRC16_GENIBUS:
					return "CRC16_GENIBUS";
				case ChecksumAlgorithm.CRC16_MAXIM:
					return "CRC16_MAXIM";
				case ChecksumAlgorithm.CRC16_MCRF4XX:
					return "CRC16_MCRF4XX";
				case ChecksumAlgorithm.CRC16_RIELLO:
					return "CRC16_RIELLO";
				case ChecksumAlgorithm.CRC16_T10_DIF:
					return "CRC16_T10_DIF";
				case ChecksumAlgorithm.CRC16_TELEDISK:
					return "CRC16_TELEDISK";
				case ChecksumAlgorithm.CRC16_TMS_37157:
					return "CRC16_TMS_37157";
				case ChecksumAlgorithm.CRC16_USB:
					return "CRC16_USB";
				case ChecksumAlgorithm.CRC_A:
					return "CRC_A";
				case ChecksumAlgorithm.CRC16_KERMIT:
					return "CRC16_KERMIT";
				case ChecksumAlgorithm.CRC16_MODBUS:
					return "CRC16_MODBUS";
				case ChecksumAlgorithm.CRC16_X_25:
					return "CRC16_X_25";
				case ChecksumAlgorithm.CRC16_XMODEM:
					return "CRC16_XMODEM";
				case ChecksumAlgorithm.CRC32:
					return "CRC32";
				case ChecksumAlgorithm.CRC32_BZIP2:
					return "CRC32_BZIP2";
				case ChecksumAlgorithm.CRC32C:
					return "CRC32C";
				case ChecksumAlgorithm.CRC32D:
					return "CRC32D";
				case ChecksumAlgorithm.CRC32_MPEG_2:
					return "CRC32_MPEG_2";
				case ChecksumAlgorithm.CRC32_POSIX:
					return "CRC32_POSIX";
				case ChecksumAlgorithm.CRC32Q:
					return "CRC32Q";
				case ChecksumAlgorithm.CRC32_JAMCRC:
					return "CRC32_JAMCRC";
		...
		public static bool isHash(ChecksumAlgorithm checksumAlgorithm)
		{
			switch (checksumAlgorithm)
			{
				case ChecksumAlgorithm.MD5:
